const CACHE_NAME = 'cache-v16'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v16',
    'estilos/styles.css?v16',
    'estilos/mediaQueries.css?v16',
    'javascript/script.js?v16',
